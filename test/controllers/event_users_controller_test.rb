...
class EventUsersControllerTest < ActionController::TestCase
  ...
  test "should create event_user" do
    assert_difference('EventUser.count') do
      post :create, event_user: { dislike: @event_user.dislike, event_id: @event_user.event_id, like: @event_user.like, user_id: @event_user.user_id }
    end
  ...
  test "should update event_user" do
    patch :update, id: @event_user, event_user: { dislike: @event_user.dislike, event_id: @event_user.event_id, like: @event_user.like, user_id: @event_user.user_id }
    assert_redirected_to event_user_path(assigns(:event_user))
  end
